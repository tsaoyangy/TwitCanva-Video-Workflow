...
export interface ImageModel {
    id: string;
    name: string;
    provider: 'volcengine' | 'kling' | 'openai';
...
export const IMAGE_MODELS: ImageModel[] = [
    ...
    { id: 'seedream-5.0-pro', name: 'Seedream 5.0 Pro', provider: 'volcengine', supportsImageToImage: true, supportsMultiImage: true, resolutions: ["1K", "2K", "4K"], aspectRatios: ["Auto", "1:1", "9:16", "16:9", "3:4", "4:3", "3:2", "2:3", "5:4", "4:5", "21:9"] },
