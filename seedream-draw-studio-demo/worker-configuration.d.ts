/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.types.jsonc --env-interface CloudflareEnv` (hash: 8aee9d490019fec307ba5a265fb6ca83)
...
interface __BaseEnv_CloudflareEnv {
	...
	ARK_API_KEY: string;
	ARK_MODEL_ID: string;
	ARK_TIMEOUT_MS: string;
	RESULT_IMAGE_SIGNING_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARK_PROVIDER" | "ARK_API_KEY" | "ARK_MODEL_ID" | "ARK_TIMEOUT_MS" | "RESULT_IMAGE_SIGNING_SECRET">> {}
}
